...
func ParseRequestBody(cc *model.CustomContext, contentType string) (map[string]interface{}, int, error) {
	...
	case "application/json":
		...
		if err != nil {
			...
			CustomPrometheus.PromMapCounter[CustomPrometheus.GetPrefixMetricName(cc.DefinedRoute.ProjectDirectory)+"ERR_PARSE_REQUEST_JSON"].Inc()
	...
	case "application/xml":
		...
		if err != nil {
			CustomPrometheus.PromMapCounter[CustomPrometheus.GetPrefixMetricName(cc.DefinedRoute.ProjectDirectory)+"ERR_PARSE_REQUEST_XML"].Inc()
	...
	default:
		...
		CustomPrometheus.PromMapCounter[CustomPrometheus.GetPrefixMetricName(cc.DefinedRoute.ProjectDirectory)+"UNKNOWN_REQUEST_CONTENT_TYPE"].Inc()
...
func ProcessingRequest(aliasName string, cc *model.CustomContext, wrapper *model.Wrapper, loopIndex int) (int, *model.CustomResponse, error) {
	...
	if err != nil {
		CustomPrometheus.PromMapCounter[CustomPrometheus.
			GetPrefixMetricName(cc.DefinedRoute.ProjectDirectory)+"ERR_SENDING_REQUEST"].
			Inc()
	...
	log.Info("cc Defined Route is ", cc.DefinedRoute.ProjectDirectory)
	log.Info("prometheus prefix : ", CustomPrometheus.Prefix)
	CustomPrometheus.PromMapCounter[CustomPrometheus.GetPrefixMetricName(cc.DefinedRoute.ProjectDirectory)+"SUCCESS_SENDING_REQUEST"].Inc()
